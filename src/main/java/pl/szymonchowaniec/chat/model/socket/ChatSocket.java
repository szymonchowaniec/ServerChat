...
import pl.szymonchowaniec.chat.model.MessageModel;
import pl.szymonchowaniec.chat.model.UserModel;
import pl.szymonchowaniec.chat.model.command.CommandFactory;
import pl.szymonchowaniec.chat.model.repository.LogRepository;
...
public class ChatSocket extends TextWebSocketHandler implements WebSocketConfigurer {
    ...
    public void afterConnectionEstablished(WebSocketSession session) throws Exception {
        ...
        sender.sendMessagePacket("Witaj w komunikatorze napisanym przez Szymona Chowańca!");
